...
{
    public class AccountBalanceNotEnoughException : BusinessException
    {
        public AccountBalanceNotEnoughException() : base(Messages.AccountBalanceNotEnoughForOrderPrice)
        {
